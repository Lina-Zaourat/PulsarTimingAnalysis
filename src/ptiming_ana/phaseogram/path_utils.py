...
def build_paths_from_config(config, config_file=None, script_dir=None):
    """Build input/output/log/shell paths from the config paths section."""
    ...
    output_rel_dir = paths.get("output_rel_dir", "results/preliminary/phasograms")
